  ...
  return (
    <section className="pt-28 md:pt-36 pb-12 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        <h1 className="text-5xl md:text-6xl lg:text-[72px] font-mono font-bold leading-tight max-w-4xl text-balance relative z-10 tracking-tight text-foreground">
        ...
        <p className="mt-6 text-[16px] md:text-[17px] text-muted-foreground max-w-xl relative z-10 leading-relaxed">
